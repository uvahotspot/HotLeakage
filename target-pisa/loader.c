 ...
 *
 * $Id: loader.c,v 1.1.1.1 2000/05/26 15:21:55 taustin Exp $
 *
 * $Log: loader.c,v $
 * Revision 1.1.1.1  2000/05/26 15:21:55  taustin
 * SimpleScalar Tool Set
 *
 *
 * Revision 1.9  1999/12/31 19:01:45  taustin
 * quad_t naming conflicts removed
 * cross-endian execution support added (w/ limited syscall support)
 *
 * Revision 1.8  1999/12/13 19:01:58  taustin
